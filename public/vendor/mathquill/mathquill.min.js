// Início MP modificações
const getSpanComFontNormal = text => `<span style="font-size: 11pt">${text}</span>`
const getSpanComFontDeSubescrito = text => `<span style="font-size: 8pt">${text}</span>`
const getSpanImitandoColorBox = children =>
  `<span style="background-color: powderblue; border: 1px solid black; margin: 0 1px; padding: 0 4px">${children}</span>`

function dynamicValueHtml(name) {
  const spanComFont = getSpanComFontNormal(name)
  return getSpanImitandoColorBox(spanComFont)
}
...
!(function() {
      ...
      (function(t, i) {
        ...
        ;(n[t] = function(i, s) {
          ...
          return a instanceof r || !i || !i.nodeType
            ? a
            : ((o = zt(r.RootBlock(), Dt(i), Bt())), (o.KIND_OF_MQ = t), r(o).__mathquillify(s, e))
        }),
      ...
      ;(t.init = function(t, e) {
        ...
        (t.jumpUpDown = function(t, e) {
          ...
          ;(s.upDownCache[t.id] = _t.copy(s)),
            ...
            n ? (n[Ct] ? s.insLeftOf(n[Ct]) : s.insAtRightEnd(n.parent)) : ((i = s.offset().left), e.seek(i, s))
        }),
        (t.offset = function() {
          var t = this,
    ...
    zt = Qt(function(t) {
      ;(t.init = function(t, e, n) {
        ...
        (t.handle = function(t, e) {
          ...
          i &&
            i.fns[t] &&
            ((n = i.APIClasses[this.KIND_OF_MQ](this)), e === Tt || e === Ct ? i.fns[t](e, n) : i.fns[t](n))
        })
      var e = []
  ...
  ;(l.prototype = $t.p),
        ...
        i.textarea
          .focus(function() {
            ;(i.blurred = !1),
              ...
              r.selection ? (r.selection.jQ.removeClass('mq-blur'), i.selectionChanged()) : r.show()
          })
          .blur(function() {
            ;(i.blurred = !0),
        ...
        return (
          n[Ct][i]
            ...
            : n.parent.bubble(function(t) {
                var e = t[s]
                return e && ('function' == typeof e && (e = t[s](n)), e instanceof St && n.jumpUpDown(t, e), e !== !0)
                  ? !1
                  : void 0
              }),
          t
      ...
      this.onNotify(function(t) {
        ...
        (t.escapeDir = function(t, e, n) {
          ...
          return (
            ...
            i.parent !== this.root ? (i.parent.moveOutOf(t, i), this.notify('move')) : void 0
          )
        }),
      ...
      ;(t.exportLatex = function() {
        ...
        (t.renderLatexMath = function(t) {
          ...
          i.eachChild('postOrder', 'dispose'),
            ...
            (e = i.jQ),
            a ? ((n = a.join('html')), e.html(n), i.jQize(e.children()), i.finalizeInsert(s.options)) : e.empty(),
            delete s.selection,
            s.insAtRightEnd(i)
        }),
    ...
    zt.open(function(t) {
      t.seek = function(t, e, n) {
        ...
        return (
          t && ((i = t.attr(xt) || t.attr(qt)), i || ((r = t.parent()), (i = r.attr(xt) || r.attr(qt)))),
      ...
      ;(Bt.p.substituteTextarea = function() {
        ...
        (t.setTextareaSelection = function() {
          ...
          this.cursor.selection &&
            ((t = this.cursor.selection.join('latex')), this.options.statelessClipboard && (t = '$' + t + '$')),
            this.selectFn(t)
        }),
      ...
      ;(t.init = function(t, n, i) {
          ...
          return t < r[Tt]
            ...
            : ((i = r[Tt]),
              void s.eachChild(function(o) {
                var a = n(o)
                return t < a[Tt]
                  ? (t - i < a[Tt] - t ? (o[Tt] ? e.insAtRightEnd(o[Tt]) : e.insLeftOf(s)) : e.insAtLeftEnd(o), !1)
                  : t > a[Ct]
                  ? void (o[Ct] ? (i = a[Ct]) : r[Ct] - t < t - a[Ct] ? e.insRightOf(s) : e.insAtRightEnd(o))
                  : (o.seek(t, e), !1)
              }))
        }),
        ...
        (t.text = function() {
          ...
          return t.foldChildren(t.textTemplate[e], function(n, i) {
            e += 1
            var s = i.text()
            return n && '(' === t.textTemplate[e] && '(' === s[0] && ')' === s.slice(-1)
    ...
    (T = Qt(y, function(t, e) {
      ;(t.join = function(t) {
        ...
        (t.keystroke = function(t, n, i) {
          return !i.options.spaceBehavesLikeTab || ('Spacebar' !== t && 'Shift-Spacebar' !== t)
            ? e.keystroke.apply(this, arguments)
            : (n.preventDefault(), void i.escapeDir('Shift-Spacebar' === t ? Tt : Ct, t, n))
        }),
            ...
            e.anticursor
              ? e.anticursor.parent === this &&
                ...
                this.anticursorPosition === c
                  ...
                  : (this.anticursorPosition < c
                      ? ((u = e[Tt].splitRight(this.anticursorPosition)), (e[Tt] = u))
        ...
        (t.selectTowards = function(t, e) {
          ...
          return (
            ...
            i[t] === this
              ...
              : ((a = this[-t]),
                a ? a.insTextAtDirEnd(s, t) : ((o = _(s).createDir(-t, e)), o.jQ.insDirOf(-t, e.selection.jQ)),
          ...
          e.createBlocks.call(this),
            ...
            (this.ends[Tt].write = function(t, e) {
              '$' !== e
                ...
                : this.isEmpty()
                ? (t.insRightOf(this.parent), this.parent.deleteTowards(dir, t), j('\\$', '$').createLeftOf(t.show()))
                : t[Ct]
                ? t[Tt]
                  ? T.prototype.write.call(this, t, e)
        ...
        (t.createBlocks = function() {
          e.createBlocks.call(this),
            (this.ends[Tt].focus = function() {
              return (
                this.parent.jQ.addClass('mq-hasCursor'), this.isEmpty() && this.parent.jQ.removeClass('mq-empty'), this
              )
            }),
            (this.ends[Tt].blur = function() {
              return (
                this.parent.jQ.removeClass('mq-hasCursor'), this.isEmpty() && this.parent.jQ.addClass('mq-empty'), this
              )
            }),
            (this.ends[Tt].write = function(t, e) {
              t.show().deleteSelection(),
                e.match(/[a-z]/i)
                  ? j(e).createLeftOf(t)
                  : (this.parent.renderCommand(t), ('\\' === e && this.isEmpty()) || this.parent.parent.write(t, e))
            }),
    ...
    (Et.nsup = Et.notsup = Et.nsupset = Et.notsupset = Et.nsuperset = Et.notsuperset = i(
      Q,
      '\\not\\supset ',
      '&#8837;',
    )),
    ...
    (Et.nsube = Et.nsubeq = Et.notsube = Et.notsubeq = Et.nsubsete = Et.nsubseteq = Et.notsubsete = Et.notsubseteq = i(
      Q,
      '\\not\\subseteq ',
      '&#8840;',
    )),
    (Et.nsupe = Et.nsupeq = Et.notsupe = Et.notsupeq = Et.nsupsete = Et.nsupseteq = Et.notsupsete = Et.notsupseteq = Et.nsupersete = Et.nsuperseteq = Et.notsupersete = Et.notsuperseteq = i(
      Q,
      '\\not\\supseteq ',
      '&#8841;',
    )),
    (Et.N = Et.naturals = Et.Naturals = i(j, '\\mathbb{N}', '&#8469;')),
    (Et.P = Et.primes = Et.Primes = Et.projective = Et.Projective = Et.probability = Et.Probability = i(
      j,
      '\\mathbb{P}',
      '&#8473;',
    )),
    ...
    (Et.C = Et.complex = Et.Complex = Et.complexes = Et.Complexes = Et.complexplane = Et.Complexplane = Et.ComplexPlane = i(
      j,
      '\\mathbb{C}',
      '&#8450;',
    )),
    ...
    (Et.o = Et.O = Et.empty = Et.emptyset = Et.oslash = Et.Oslash = Et.nothing = Et.varnothing = i(
      Q,
      '\\varnothing ',
      '&empty;',
    )),
    ...
    (A = Qt(j, function(t, e) {
      t.createLeftOf = function(t) {
        ...
        ((t[Tt] instanceof R && t[Tt].isItalic !== !1) ||
          (t[Tt] instanceof rt && t[Tt][Tt] instanceof R && t[Tt][Tt].isItalic !== !1))
          ? (Et._().createLeftOf(t), e.createLeftOf.call(this, t), t.insRightOf(t.parent.parent))
          : e.createLeftOf.call(this, t)
      }
    })),
    (R = Qt(k, function(t, e) {
      ;(t.init = function(t, n) {
        ...
        (t.text = function() {
          var t = this.ctrlSeq
          return (
            !this[Tt] || this[Tt] instanceof R || this[Tt] instanceof Q || '\\ ' === this[Tt].ctrlSeq || (t = '*' + t),
            !this[Ct] || this[Ct] instanceof Q || this[Ct] instanceof rt || (t += '*'),
            t
          )
        })
    })),
    ...
    (function() {
      ...
      for (
        e = 'sin cos tan arcsin arccos arctan sinh cosh tanh sec csc cot coth'.split(' '), t = 0;
        t < e.length;
        t += 1
      )
        z[e[t]] = 1
      for (n = 'sin cos tan sec cosec csc cotan cot ctg'.split(' '), t = 0; t < n.length; t += 1)
        M[n[t]] = M['arc' + n[t]] = M[n[t] + 'h'] = M['ar' + n[t] + 'h'] = M['arc' + n[t] + 'h'] = 1
  ...
  ;(Et.operatorname = Qt(O, function(e) {
    ...
    (Et['&'] = i(N, '\\&', '&amp;')),
    (Et['%'] = i(N, '\\%', '%')),
    (Et.alpha = Et.beta = Et.gamma = Et.delta = Et.zeta = Et.eta = Et.theta = Et.iota = Et.kappa = Et.mu = Et.nu = Et.xi = Et.rho = Et.sigma = Et.tau = Et.chi = Et.psi = Et.omega = Qt(
      R,
      function(t, e) {
        t.init = function(t) {
          e.init.call(this, '\\' + t + ' ', '&' + t + ';')
    ...
    // Início MP modificações
    // Variáveis
    (Et.varxvar = i(R, '\\varxvar', dynamicValueHtml('x'))),
    (Et.varyvar = i(R, '\\varyvar', dynamicValueHtml('y'))),
    (Et.varzvar = i(R, '\\varzvar', dynamicValueHtml('z'))),
    (Et.varuvar = i(R, '\\varuvar', dynamicValueHtml('u'))),
    (Et.varvvar = i(R, '\\varvvar', dynamicValueHtml('v'))),
    (Et.varwvar = i(R, '\\varwvar', dynamicValueHtml('w'))),
    (Et.varavar = i(R, '\\varavar', dynamicValueHtml('a'))),
    (Et.varbvar = i(R, '\\varbvar', dynamicValueHtml('b'))),
    (Et.varcvar = i(R, '\\varcvar', dynamicValueHtml('c'))),
    // Família função f
    (Et.varfonevar = i(R, '\\varfonevar', dynamicValueHtml('f1'))),
    (Et.varftwovar = i(R, '\\varftwovar', dynamicValueHtml('f2'))),
    (Et.varfthreevar = i(R, '\\varfthreevar', dynamicValueHtml('f3'))),
    (Et.varffourvar = i(R, '\\varffourvar', dynamicValueHtml('f4'))),
    (Et.varffivevar = i(R, '\\varffivevar', dynamicValueHtml('f5'))),
    (Et.varfsixvar = i(R, '\\varfsixvar', dynamicValueHtml('f6'))),
    (Et.varfsevenvar = i(R, '\\varfsevenvar', dynamicValueHtml('f7'))),
    (Et.varfeightvar = i(R, '\\varfeightvar', dynamicValueHtml('f8'))),
    (Et.varfninevar = i(R, '\\varfninevar', dynamicValueHtml('f9'))),
    // Família função g
    (Et.vargonevar = i(R, '\\vargonevar', dynamicValueHtml('g1'))),
    (Et.vargtwovar = i(R, '\\vargtwovar', dynamicValueHtml('g2'))),
    (Et.vargthreevar = i(R, '\\vargthreevar', dynamicValueHtml('g3'))),
    (Et.vargfourvar = i(R, '\\vargfourvar', dynamicValueHtml('g4'))),
    (Et.vargfivevar = i(R, '\\vargfivevar', dynamicValueHtml('g5'))),
    (Et.vargsixvar = i(R, '\\vargsixvar', dynamicValueHtml('g6'))),
    (Et.vargsevenvar = i(R, '\\vargsevenvar', dynamicValueHtml('g7'))),
    (Et.vargeightvar = i(R, '\\vargeightvar', dynamicValueHtml('g8'))),
    (Et.vargninevar = i(R, '\\vargninevar', dynamicValueHtml('g9'))),
    // Família função h
    (Et.varhonevar = i(R, '\\varhonevar', dynamicValueHtml('h1'))),
    (Et.varhtwovar = i(R, '\\varhtwovar', dynamicValueHtml('h2'))),
    (Et.varhthreevar = i(R, '\\varhthreevar', dynamicValueHtml('h3'))),
    (Et.varhfourvar = i(R, '\\varhfourvar', dynamicValueHtml('h4'))),
    (Et.varhfivevar = i(R, '\\varhfivevar', dynamicValueHtml('h5'))),
    (Et.varhsixvar = i(R, '\\varhsixvar', dynamicValueHtml('h6'))),
    (Et.varhsevenvar = i(R, '\\varhsevenvar', dynamicValueHtml('h7'))),
    (Et.varheightvar = i(R, '\\varheightvar', dynamicValueHtml('h8'))),
    (Et.varhninevar = i(R, '\\varhninevar', dynamicValueHtml('h9'))),
    // Família função p
    (Et.varponevar = i(R, '\\varponevar', dynamicValueHtml('p1'))),
    (Et.varptwovar = i(R, '\\varptwovar', dynamicValueHtml('p2'))),
    (Et.varpthreevar = i(R, '\\varpthreevar', dynamicValueHtml('p3'))),
    (Et.varpfourvar = i(R, '\\varpfourvar', dynamicValueHtml('p4'))),
    (Et.varpfivevar = i(R, '\\varpfivevar', dynamicValueHtml('p5'))),
    (Et.varpsixvar = i(R, '\\varpsixvar', dynamicValueHtml('p6'))),
    (Et.varpsevenvar = i(R, '\\varpsevenvar', dynamicValueHtml('p7'))),
    (Et.varpeightvar = i(R, '\\varpeightvar', dynamicValueHtml('p8'))),
    (Et.varpninevar = i(R, '\\varpninevar', dynamicValueHtml('p9'))),
    // Família função q
    (Et.varqonevar = i(R, '\\varqonevar', dynamicValueHtml('q1'))),
    (Et.varqtwovar = i(R, '\\varqtwovar', dynamicValueHtml('q2'))),
    (Et.varqthreevar = i(R, '\\varqthreevar', dynamicValueHtml('q3'))),
    (Et.varqfourvar = i(R, '\\varqfourvar', dynamicValueHtml('q4'))),
    (Et.varqfivevar = i(R, '\\varqfivevar', dynamicValueHtml('q5'))),
    (Et.varqsixvar = i(R, '\\varqsixvar', dynamicValueHtml('q6'))),
    (Et.varqsevenvar = i(R, '\\varqsevenvar', dynamicValueHtml('q7'))),
    (Et.varqeightvar = i(R, '\\varqeightvar', dynamicValueHtml('q8'))),
    (Et.varqninevar = i(R, '\\varqninevar', dynamicValueHtml('q9'))),
    // Família função r
    (Et.varronevar = i(R, '\\varronevar', dynamicValueHtml('r1'))),
    (Et.varrtwovar = i(R, '\\varrtwovar', dynamicValueHtml('r2'))),
    (Et.varrthreevar = i(R, '\\varrthreevar', dynamicValueHtml('r3'))),
    (Et.varrfourvar = i(R, '\\varrfourvar', dynamicValueHtml('r4'))),
    (Et.varrfivevar = i(R, '\\varrfivevar', dynamicValueHtml('r5'))),
    (Et.varrsixvar = i(R, '\\varrsixvar', dynamicValueHtml('r6'))),
    (Et.varrsevenvar = i(R, '\\varrsevenvar', dynamicValueHtml('r7'))),
    (Et.varreightvar = i(R, '\\varreightvar', dynamicValueHtml('r8'))),
    (Et.varrninevar = i(R, '\\varrninevar', dynamicValueHtml('r9'))),
    // Família função s
    (Et.varsonevar = i(R, '\\varsonevar', dynamicValueHtml('s1'))),
    (Et.varstwovar = i(R, '\\varstwovar', dynamicValueHtml('s2'))),
    (Et.varsthreevar = i(R, '\\varsthreevar', dynamicValueHtml('s3'))),
    (Et.varsfourvar = i(R, '\\varsfourvar', dynamicValueHtml('s4'))),
    (Et.varsfivevar = i(R, '\\varsfivevar', dynamicValueHtml('s5'))),
    (Et.varssixvar = i(R, '\\varssixvar', dynamicValueHtml('s6'))),
    (Et.varssevenvar = i(R, '\\varssevenvar', dynamicValueHtml('s7'))),
    (Et.varseightvar = i(R, '\\varseightvar', dynamicValueHtml('s8'))),
    (Et.varsninevar = i(R, '\\varsninevar', dynamicValueHtml('s9'))),
    // Função calculada F
    (Et.varFonevar = i(R, '\\varFonevar', dynamicValueHtml('F1'))),
    (Et.varFtwovar = i(R, '\\varFtwovar', dynamicValueHtml('F2'))),
    (Et.varFthreevar = i(R, '\\varFthreevar', dynamicValueHtml('F3'))),
    ...
    (Et.Gamma = Et.Delta = Et.Theta = Et.Lambda = Et.Xi = Et.Pi = Et.Sigma = Et.Phi = Et.Psi = Et.Omega = Et.forall = Qt(
      j,
      function(t, e) {
        t.init = function(t) {
          e.init.call(this, '\\' + t + ' ', '&' + t + ';')
    ...
    (U = Qt(Q, function(t) {
      ;(t.init = j.prototype.init),
        (t.contactWeld = t.siblingCreated = t.siblingDeleted = function(t, e) {
          return e !== Ct
            ? ((this.jQ[0].className = !this[Tt] || this[Tt] instanceof Q ? '' : 'mq-binary-operator'), this)
            : void 0
        })
    })),
    (Et['+'] = i(U, '+', '+')),
    ...
    (H = { ctrlSeq: '\\le ', html: '&le;', text: '≤', ctrlSeqStrict: '<', htmlStrict: '&lt;', textStrict: '<' }),
    (G = { ctrlSeq: '\\ge ', html: '&ge;', text: '≥', ctrlSeqStrict: '>', htmlStrict: '&gt;', textStrict: '>' }),
    (Et['<'] = Et.lt = i(W, H, !0)),
    (Et['>'] = Et.gt = i(W, G, !0)),
    ...
    (V = Z.style),
    (J = { transform: 1, WebkitTransform: 1, MozTransform: 1, OTransform: 1, msTransform: 1 })
  for (et in J)
    if (et in V) {
      tt = et
      break
  ...
  tt
      ...
      (Y = function(t, e, n) {
        ...
        ;(e /= 1 + (n - 1) / 2),
          ...
          t.hasClass('mq-matrixed-container') ||
            t.addClass('mq-matrixed-container').wrapInner('<span class="mq-matrixed"></span>'),
          (s = t
            .children()
            .css('filter', 'progid:DXImageTransform.Microsoft.Matrix(M11=' + e + ",SizingMethod='auto expand')")),
          i(),
          (r = setInterval(i)),
    ...
    (Et.underline = i(nt, '\\underline', 'span', 'class="mq-non-leaf mq-underline"')),
    (Et.overline = Et.bar = i(nt, '\\overline', 'span', 'class="mq-non-leaf mq-overline"')),
    (Et.overrightarrow = i(nt, '\\overrightarrow', 'span', 'class="mq-non-leaf mq-overarrow mq-arrow-right"')),
    (Et.overleftarrow = i(nt, '\\overleftarrow', 'span', 'class="mq-non-leaf mq-overarrow mq-arrow-left"')),
    (it = Et.textcolor = Qt(O, function(t, e) {
          ...
          for (e = Tt; e; e = e === Tt ? Ct : !1)
            if (this[e] instanceof rt) {
              ...
              this.remove(),
                t &&
                  t[Tt] === this &&
                  (e === Ct && o ? (o[Tt] ? t.insRightOf(o[Tt]) : t.insAtLeftEnd(o.parent)) : t.insRightOf(this[e]))
              break
            }
          this.respace()
        }),
        ...
        (t.finalizeTree = function() {
          this.ends[Tt].write = function(t, e) {
            if (t.options.autoSubscriptNumerals && this === this.parent.sub) {
              ...
              var n = this.chToCmd(e)
              return (
                n instanceof k ? t.deleteSelection() : t.clearSelection().insRightOf(this.parent),
        ...
        (t.deleteTowards = function(t, n) {
          if (n.options.autoSubscriptNumerals && this.sub) {
            ...
            i instanceof k ? i.remove() : i && i.deleteTowards(t, n.insAtDirEnd(-t, this.sub)),
              this.sub.isEmpty() &&
                (this.sub.deleteOutOf(Tt, n.insAtLeftEnd(this.sub)), this.sup && n.insDirOf(-t, this))
            ...
            (function(t, e, n, i) {
              t[e].deleteOutOf = function(s, r) {
                ...
                ;(t.supsub = n),
                  ...
                  'sub' === e && Dt(t.jQ.addClass('mq-sup-only')[0].lastChild).remove(),
                  this.remove()
              }
    ...
    (ot = Qt(O, function(t, e) {
      ;(t.init = function(t, e) {
        ...
        (t.createLeftOf = function(t) {
          e.createLeftOf.apply(this, arguments),
            t.options.sumStartsWithNEquals && (I('n').createLeftOf(t), K().createLeftOf(t))
        }),
        (t.latex = function() {
          function t(t) {
    ...
    (at = Et.frac = Et.dfrac = Et.cfrac = Et.fraction = Qt(O, function(t, e) {
      ;(t.ctrlSeq = '\\frac'),
        (t.htmlTemplate =
    ...
    (lt = Et.over = At['/'] = Qt(at, function(e, n) {
      e.createLeftOf = function(e) {
        if (!this.replacedFragment) {
          ...
          i instanceof ot &&
            i[Ct] instanceof rt &&
            ((i = i[Ct]), i[Ct] instanceof rt && i[Ct].ctrlSeq != i.ctrlSeq && (i = i[Ct])),
            i !== e[Tt] && (this.replaces(Lt(i[Ct] || e.parent.ends[Tt], e[Tt])), (e[Tt] = i))
        }
    ...
    (ct = Et.sqrt = Et['√'] = Qt(O, function(t, e) {
      ;(t.ctrlSeq = '\\sqrt'),
        ...
        (t.reflow = function() {
          ...
          Y(t.prev(), 1, t.innerHeight() / +t.css('fontSize').slice(0, -2) - 0.1)
        })
    })),
    ...
    (ft = Qt(Qt(O, p), function(e, n) {
      ;(e.init = function(t, e, i, s, r) {
        ...
        (e.createLeftOf = function(t) {
          ...
          this.replacedFragment ||
            ...
            i
              ...
              : ((i = this),
                (s = i.side),
                i.replacedFragment ? (i.side = 0) : t[-s] && (i.replaces(Lt(t[-s], t.parent.ends[-s], s)), (t[-s] = 0)),
        ...
        (e.deleteSide = function(t, e, n) {
          ...
          if (((i = n.options), (s = !this.side), (this.side = -t), this.oppBrack(i, this.ends[Tt].ends[this.side], t)))
            ...
            if (this.oppBrack(i, this.parent.parent, t))
              ...
              ;(this.sides[t] = { ch: pt[this.sides[this.side].ch], ctrlSeq: pt[this.sides[this.side].ctrlSeq] }),
                this.delimjQs
                  .removeClass('mq-ghost')
                  .eq(t === Tt ? 0 : 1)
                  .addClass('mq-ghost')
